...
model.add_node(id=6, x=3.526711514, y=4.854101966, z=1.98057153)
model.add_node(id=7, x=5.706339098, y=-1.854101966, z=1.98057153)
model.add_node(id=8, x=7.35089E-16, y=-6.000000000, z=1.98057153)
model.add_node(id=9, x=-5.706339098, y=-1.854101966, z=1.98057153)
model.add_node(id=10, x=-3.526711514, y=4.854101966, z=1.98057153)
model.add_node(id=11, x=0.000000000, y=0.000000000, z=3.000000000)
...
model.add_single_load(id='load 6', node_id=6, fw=-1)
model.add_single_load(id='load 7', node_id=7, fw=-1)
model.add_single_load(id='load 8', node_id=8, fw=-1)
model.add_single_load(id='load 9', node_id=9, fw=-1)
